...
Por otro lado también se hizo una prueba para cambiar la tasa de aprendizaje a fin de comprobar si con una tasa más reducida el aprendizaje no aqueja el pequeño sobreajuste que experimentamos en los experimentos anteriores. En cambio lo que se observó es que, para el mismo número de pasadas, y con una capa oculta de 700 neuronas, el aprendizaje resultaba demasiado lento con una tasa menor, con lo que se empobrecían los resultados obtenidos. Esto puede apreciarse en la siguiente gráfica comparativa:
...
\begin{figure}[H]
\includegraphics[scale=0.5]{img/momentos.pdf}
\caption{Comparación de tasas de apredizaje}
\end{figure}
